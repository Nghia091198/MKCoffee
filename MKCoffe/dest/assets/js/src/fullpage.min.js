...
! function(e, t, n, o, r) { "function" == typeof define && define.amd ? define(function() { return e.fullpage = o(t, n), e.fullpage }) : "object" == typeof exports ? module.exports = o(t, n) : t.fullpage = o(t, n) }(this, window, document, function(zt, jt) { "use strict"; var Pt = "fullpage-wrapper",
    ...
    function eo(e, t) { return a(e, t, "previousElementSibling") } return zt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) { t = t || zt; for (var n = 0; n < this.length; n++) e.call(t, this[n], n, this) }), zt.fp_utils = { $: yn, deepExtend: En, hasClass: Ln, getWindowHeight: xn, css: Tn, until: n, prevUntil: kn, nextUntil: On, prev: Mn, next: Cn, last: Hn, index: In, getList: l, hide: Bn, show: Rn, isArrayOrList: i, addClass: Nn, removeClass: zn, appendTo: jn, wrap: o, wrapAll: Pn, wrapInner: Dn, unwrap: Vn, closest: Wn, after: Yn, before: Fn, insertBefore: r, getScrollTop: Un, siblings: Xn, preventDefault: Kn, isFunction: _n, trigger: $n, matches: qn, toggle: Qn, createElementFromHTML: Gn, remove: Jn, filter: function(e, t) { Array.prototype.filter.call(e, t) }, untilAll: a, nextAll: Zn, prevAll: eo, showError: bn },
        function(e, E) { var n = E && new RegExp("([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$").test(E.licenseKey) || -1 < jt.domain.indexOf("alvarotrigo.com"),
                ...
                p.k = En({}, p.m); var g, m, S, w, b, O, M, y, C, H = zt.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" },
                ...
                Ct(), zt.fp_easings = En(zt.fp_easings, { easeInOutCubic: function(e, t, n, o) { return (e /= o / 2) < 1 ? n / 2 * e * e * e + t : n / 2 * ((e -= 2) * e * e + 2) + t } }), d && (h.version = "3.0.8", h.setAutoScrolling = Z, h.setRecordHistory = ee, h.setScrollingSpeed = te, h.setFitToSection = ne, h.setLockAnchors = function(e) { E.lockAnchors = e }, h.setMouseWheelScrolling = oe, h.setAllowScrolling = re, h.setKeyboardScrolling = le, h.moveSectionUp = ae, h.moveSectionDown = se, h.silentMoveTo = ce, h.moveTo = ue, h.moveSlideRight = fe, h.moveSlideLeft = de, h.fitToSection = xe, h.reBuild = ve, h.setResponsive = he, h.getFullpageData = function() { return E }, h.destroy = function(e) { Z(!1, "internal"), re(!0), ie(!1), le(!1), Nn(d, Yt), [b, w, m, O, M, C, S, P].forEach(function(e) { clearTimeout(e) }), zt.removeEventListener("scroll", Le), zt.removeEventListener("hashchange", qe), zt.removeEventListener("resize", at), jt.removeEventListener("keydown", Ge), jt.removeEventListener("keyup", Je), ["click", "touchstart"].forEach(function(e) { jt.removeEventListener(e, ge) }), ["mouseenter", "touchstart", "mouseleave", "touchend"].forEach(function(e) { jt.removeEventListener(e, Se, !0) }), e && (Tt(0), yn("img[data-src], source[data-src], audio[data-src], iframe[data-src]", d).forEach(function(e) { Ve(e, "src") }), yn("img[data-srcset]").forEach(function(e) { Ve(e, "srcset") }), Jn(yn(nn + ", " + pn + ", " + gn)), Tn(yn(qt), { height: "", "background-color": "", padding: "" }), Tn(yn(ln), { width: "" }), Tn(d, { height: "", position: "", "-ms-touch-action": "", "touch-action": "" }), Tn(r, { overflow: "", height: "" }), zn(u, Ft), zn(L, Vt), L.className.split(/\s+/).forEach(function(e) { 0 === e.indexOf(Ut) && zn(L, e) }), yn(qt + ", " + ln).forEach(function(e) { E.scrollOverflowHandler && E.scrollOverflow && E.scrollOverflowHandler.remove(e), zn(e, dn + " " + Xt + " " + _t); var t = e.getAttribute("data-fp-styles");
                        t && e.setAttribute("style", e.getAttribute("data-fp-styles")), Ln(e, $t) && !V && e.removeAttribute("data-anchor") }), ft(d), [Jt, fn, cn].forEach(function(e) { yn(e, d).forEach(function(e) { Vn(e) }) }), Tn(d, { "-webkit-transition": "none", transition: "none" }), zt.scrollTo(0, 0), [$t, rn, un].forEach(function(e) { zn(yn("." + e), e) })) }, h.getActiveSection = function() { return new Rt(yn(Qt)[0]) }, h.getActiveSlide = function() { return je(yn(an, yn(Qt)[0])[0]) }, h.test = { top: "0px", translate3d: "translate3d(0px, 0px, 0px)", translate3dH: function() { for (var e = [], t = 0; t < yn(E.sectionSelector, d).length; t++) e.push("translate3d(0px, 0px, 0px)"); return e }(), left: function() { for (var e = [], t = 0; t < yn(E.sectionSelector, d).length; t++) e.push(0); return e }(), options: E, setAutoScrolling: Z }, h.shared = { afterRenderActions: Ee, isNormalScrollElement: !1 }, zt.fullpage_api = h, E.$ && Object.keys(h).forEach(function(e) { E.$.fn.fullpage[e] = h[e] }), E.css3 && (E.css3 = function() { var e, t = jt.createElement("p"),
                        ...
                        t.length && t.length === yn(qt).length && (V = !0, t.forEach(function(e) { E.anchors.push(e.getAttribute("data-anchor").toString()) })) } if (!E.navigationTooltips.length) { var n = "[data-tooltip]",
            ...
            function Z(e, t) { e || Tt(0), Mt("autoScrolling", e, t); var n = yn(Qt)[0]; if (E.autoScrolling && !E.scrollBar) Tn(r, { overflow: "hidden", height: "100%" }), ee(D.recordHistory, "internal"), Tn(d, { "-ms-touch-action": "none", "touch-action": "none" }), null != n && Tt(n.offsetTop);
                else if (Tn(r, { overflow: "visible", height: "initial" }), ee(!!E.autoScrolling && D.recordHistory, "internal"), Tn(d, { "-ms-touch-action": "", "touch-action": "" }), null != n) { var o = Pe(n.offsetTop);
            ...
            function ie(e) { e ? (oe(!0), function() { if (o || l) { E.autoScrolling && (L.removeEventListener(I.touchmove, Te, { passive: !1 }), L.addEventListener(I.touchmove, Te, { passive: !1 })); var e = E.touchWrapper;
            ...
            function ve(e) { if (!Ln(d, Yt)) { T = !0, A = xn(), s = An(); for (var t = yn(qt), n = 0; n < t.length; ++n) { var o = t[n],
                    ...
                    E.scrollOverflow && g.createScrollBarForAll(); var l = In(yn(Qt)[0], qt);
            ...
            function Se(e) { var t = e.type,
                    ...
                    i = "mouseleave" === t ? e.toElement || e.relatedTarget : e.target; if (i == jt || !i) return ie(!0), void(r && E.scrollOverflowHandler.setIscroll(i, !0)); "touchend" === t && (W = !1, setTimeout(function() { W = !0 }, 800)), ("mouseenter" !== t || W) && (E.normalScrollElements.split(",").forEach(function(e) { if (!o) { var t = qn(i, e),
                            n = Wn(i, e);
                        (t || n) && (h.shared.isNormalScrollElement || (ie(!1), r && E.scrollOverflowHandler.setIscroll(i, !1)), h.shared.isNormalScrollElement = !0, o = !0) } }), !o && h.shared.isNormalScrollElement && (ie(!0), r && E.scrollOverflowHandler.setIscroll(i, !0), h.shared.isNormalScrollElement = !1)) }
            ...
            function Re(e, t, n) { if (null != e) { var o, r, i, l, a, s, c, u, f, d = { element: e, callback: t, isMovementUp: n, dtop: (r = (o = e).offsetHeight, i = o.offsetTop, a = Q < (l = i), s = l - A + r, c = E.bigSectionsDestination, A < r ? (a || c) && "bottom" !== c || (l = s) : (a || T && null == Cn(o)) && (l = s), Q = l), yMovement: vt(e), anchorLink: e.getAttribute("data-anchor"), sectionIndex: In(e, qt), activeSlide: yn(an, e)[0], activeSection: yn(Qt)[0], leavingSection: In(yn(Qt), qt) + 1, localIsResizing: T }; if (!(d.activeSection == e && !T || E.scrollBar && Un() === d.dtop && !Ln(e, Zt))) { if (null != d.activeSlide && (u = d.activeSlide.getAttribute("data-anchor"), f = In(d.activeSlide)), !d.localIsResizing) { var v = d.yMovement; if (void 0 !== n && (v = n ? "up" : "down"), d.direction = v, _n(E.onLeave) && !1 === Ne("onLeave", d)) return }
                        E.autoScrolling && E.continuousVertical && void 0 !== d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && ((p = d).isMovementUp ? Fn(yn(Qt)[0], Zn(p.activeSection, qt)) : Yn(yn(Qt)[0], eo(p.activeSection, qt).reverse()), Tt(yn(Qt)[0].offsetTop), Be(), p.wrapAroundElements = p.activeSection, p.dtop = p.element.offsetTop, p.yMovement = vt(p.element), d = p), d.localIsResizing || Ke(d.activeSection), E.scrollOverflow && E.scrollOverflowHandler.beforeLeave(), Nn(e, Xt), zn(Xn(e), Xt), Ye(e), E.scrollOverflow && E.scrollOverflowHandler.onLeave(), k = h.test.isTesting, bt(f, u, d.anchorLink, d.sectionIndex),
                            function(e) { var t = E.scrollingSpeed < 700,
                                    ...
                                    h.test.top = -e.dtop + "px", Ht(r.element, r.options, E.scrollingSpeed, function() { E.scrollBar ? setTimeout(function() { De(e) }, 30) : (De(e), k = !t) }) }
            ...
            function Fe(e) { E.scrollOverflow && (clearTimeout(j), j = setTimeout(function() { Ln(L, Vt) || g.createScrollBar(e) }, 200)) }
            ...
            function it(e, t, n) { var o, r, i = Wn(e, qt),
                ...
                l.xMovement = (o = l.prevSlideIndex, r = l.slideIndex, o == r ? "none" : r < o ? "left" : "right"), l.direction = l.direction ? l.direction : l.xMovement, l.localIsResizing || (k = !1), E.onSlideLeave && !l.localIsResizing && "none" !== l.xMovement && _n(E.onSlideLeave) && !1 === Ne("onSlideLeave", l) ? a = !1 : (Nn(t, Xt), zn(Xn(t), Xt), l.localIsResizing || (Ke(l.prevSlide), Ye(t)), !E.loopHorizontal && E.controlArrows && (Qn(yn(Sn, i), 0 !== l.slideIndex), Qn(yn(wn, i), null != Cn(t))), Ln(i, Xt) && !l.localIsResizing && bt(l.slideIndex, l.slideAnchor, l.anchorLink, l.sectionIndex), function(e, t, n) { var o = t.destinyPos; if (E.css3) { var r = "translate3d(-" + Math.round(o.left) + "px, 0px, 0px)";
                        h.test.translate3dH[t.sectionIndex] = r, Tn(ut(yn(fn, e)), kt(r)), b = setTimeout(function() { n && lt(t) }, E.scrollingSpeed) } else h.test.left[t.sectionIndex] = Math.round(o.left), Ht(e, Math.round(o.left), E.scrollingSpeed, function() { n && lt(t) }) }(e, l, !0)) }
            ...
            function at() { T = !0, clearTimeout(m), m = setTimeout(function() { for (var e = 0; e < 4; e++) S = setTimeout(st, 200 * e) }, 200) }

            function st() { if (ct(), o) { var e = jt.activeElement; if (!qn(e, "textarea") && !qn(e, "input") && !qn(e, "select")) { var t = xn();
            ...
            function gt(e, t) { t ? ut(d) : ft(d), Tn(d, kt(e)), h.test.translate3d = e, setTimeout(function() { zn(d, Wt) }, 10) }
            ...
            function xt(e) { var t = []; return t.y = void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, t.x = void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, l && Oe(e) && E.scrollBar && void 0 !== e.touches && (t.y = e.touches[0].pageY, t.x = e.touches[0].pageX), t }
