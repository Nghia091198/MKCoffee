...
const router = { /* Path */
    ...
    html: {
        src: [
            'src/**/*', '!src/assets/js/*', '!src/assets/img/*', '!src/assets/css/*', '!src/assets/scss/*', '!src/assets/lib/*'
        ],
        dest: 'dest'
    },
    scss: {
...
exports.default = parallel( /* >>> gulp */
    clean, buildHTML, buildOtherCSS, buildSCSS, buildCSS, buildJS, buildImg, buildLib
);
